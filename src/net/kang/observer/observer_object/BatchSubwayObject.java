...
// 간이역 구현 객체. 간이역의 등급이 제일 낮다. 직원이 아무도 배치 안 되었다고 가정하자.
public class BatchSubwayObject implements SubwayObserver, SubwayInterface {
    ...
    public BatchSubwayObject(LineSubject lineSubject, String subwayName, boolean hasTransfer){
    ...
    public String getSubwayInfo() {
        return String.format("[간이역] %s%s", this.getSubwayName(), (this.getHasTransfer()) ? "[환승]" : "");
    }
